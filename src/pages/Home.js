    ...
    <>
      ...
      <div className='mt-8'>
        <div className='flex lg:w-[95%] md:w-[95%] w-[90%] mx-auto flex-wrap justify-around'>
          {cards.map((card, index) => (
            <div
              className='card h-auto mb-8 lg:w-[270px] md:w-[300px] w-[320px] flex justify-around flex-col bg-white'
              key={index}
              style={{ border: "2px solid silver" }}
              onClick={() => handleCardClick(card)}
            >
              <div className='card-title'>
                <h1 className='text-black bg-[#fddc58] w-[100%] text-center font-bold text-[23px]'>{card.status}</h1>
              </div>
              <Swiper
                grabCursor={true}
                effect={'creative'}
